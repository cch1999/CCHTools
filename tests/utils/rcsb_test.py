...
from cchtools.utils.rcsb import (
    RcsbPdbClusters,
    get_pdb_entities,
    match_pdb_chain_to_entity,
    pdb_check_obsolete,
)
...
class TestRcsbPdbClusters:
    ...
    def test_get_pdbs_in_cluster(self, clusters):
        ...
        # Set up clusters
        clusters.clusters = {"1ABC_A": 42, "2DEF_B": 42, "AF_XYZ_C": 42, "3GHI_D": 43}
...
def test_pdb_check_obsolete(mock_get):
    ...
    mock_response.json.return_value = {"1abc": [{"status_code": "OBS", "superceded_by": ["2xyz"]}]}
    ...
    mock_response.json.return_value = {"2xyz": [{"status_code": "REL"}]}
