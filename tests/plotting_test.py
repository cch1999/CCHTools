...
from cchtools.utils.images import open_image, smile_to_image
...
def test_create_comparison_plot_no_reference(sample_data):
    ...
    fig = create_comparison_plot(
        images=[img_1, img_1], smile_imgs=smile_imgs[:2], texts=texts[:2], reference_img=False
    )
...
def test_create_comparison_plot_custom_figsize(sample_data):
    ...
    custom_figsize = (12, 6)
    fig = create_comparison_plot(
        images=[img_1, img_1, img_2], smile_imgs=smile_imgs, texts=texts, figsize=custom_figsize
    )
